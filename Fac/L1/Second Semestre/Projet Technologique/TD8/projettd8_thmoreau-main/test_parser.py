...
class test_parser(unittest.TestCase):
    ...
    def test_numberElementInColumnWithoutComment(self):
        ...
        with open(self.parser1.file_path_name) as file:
            listElement = file.readlines()
    ...
    def test_numberElementInColumnWithComment(self):
        ...
        with open(self.parser2.file_path_name) as file:
            listElement = file.readlines()
        self.assertTrue((numberOfElement + 1) == len(listElement)) 
