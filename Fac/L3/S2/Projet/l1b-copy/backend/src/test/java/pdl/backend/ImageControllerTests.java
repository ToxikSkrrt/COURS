...
public class ImageControllerTests {
	...
	public void getImageShouldReturnNotFound() throws Exception {
		this.mockMvc.perform(get("/images/0312")).andDo(print()).andExpect(status().isNotFound());
	}
	...
	public void deleteImageShouldReturnNotFound() throws Exception {
		this.mockMvc.perform(delete("/images/0312")).andDo(print()).andExpect(status().isNotFound());
